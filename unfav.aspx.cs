...
{
    public partial class unfav : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                itemController.removeFavorite(userId, Int32.Parse(itemId));
            }
            catch (Exception err)
            {
            ...
            MessageBox.Attributes.Add("role", "alert");
            MessageBox.InnerText = "favorite removed successfully"; 
        }
    }
}